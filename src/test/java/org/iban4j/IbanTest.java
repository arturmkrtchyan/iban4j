...
final class IbanTest {
  ...
  public void ibanConstructionRandomDoesNotOverwriteBranchCode() {
    final Iban iban =
        new Iban.Builder().countryCode(CountryCode.AL).branchCode("1234").buildRandom();
  ...
  public void ibanConstructionRandomDoesNotOverwriteAccountType() {
    final Iban iban = new Iban.Builder().countryCode(CountryCode.BR).accountType("A").buildRandom();
  ...
  public void ibanConstructionRandomDoesNotOverwriteOwnerAccountType() {
    final Iban iban =
        new Iban.Builder().countryCode(CountryCode.BR).ownerAccountType("C").buildRandom();
  ...
  @Test
  public void
      ibanConstructionWithLackingNationalCheckDigitShouldThrowExceptionIfValidationRequested() {
    final IbanFormatException thrown =
        assertThrows(
    ...
    assertThat(
        thrown.getMessage(), containsString("nationalCheckDigit is required; it cannot be null"));
  }
}
