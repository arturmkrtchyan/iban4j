...
public class InvalidCheckDigitException extends Iban4jException {
  ...
  /**
   * Constructs a <code>InvalidCheckDigitException</code> with the specified detail message.
   *
  ...
  /**
   * Constructs a <code>InvalidCheckDigitException</code> with the specified detail message and
   * cause.
   *
   * @param s the detail message.
   * @param t the cause.
  ...
  /**
   * Constructs a <code>InvalidCheckDigitException</code> with the specified cause.
   *
   * @param t the cause.
   */
